<%-- 
    Document   : consultar
    Created on : 29/04/2021, 05:49:33 PM
    Author     : user
--%>
                    ...
                    <%
                        ...
                        try{
                            ...
                            try{
                                ...
                                q = "select * from registrarusuario order by nom_usu asc";
                                ...
                                while(rs.next()){
                                    ...
                                    <tr>
                                        ...
                                        <td> <a href="editar.jtsp?id=<%=rs.getInt("id_usu")%>">Editar</a> </td>
                                        <td> <a href="borrar.jtsp?id=<%=rs.getInt("id_usu")%>">Borrar</a> </td>
                                    </tr>
                                    <%
                                }
                                rs.close(); 
